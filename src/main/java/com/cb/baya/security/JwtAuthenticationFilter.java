...
// */
//package com.cbsolutions.smartfarmer.security;
//
//import com.cbsolutions.smartfarmer.user.CustomUserDetailsService;
//import com.cbsolutions.smartfarmer.user.User;
//import com.cbsolutions.smartfarmer.user.UserRepository;
...
//
//                if (findOneByUsername == null || findOneByUsername.getDeleted()) {
//                    throw new Exception(username + " is currently disabled");
//                }
//
